...
**Answer**: The thirtieth percentile for healthiness score out of 100 is 34.5.  This means that 30% of the cereals in the sample have a healthiness of 34.5 of below and 70% of cereals have a score of 34.5 or above.
...
**Answer**: Nabisco brand has the highest median cereal healthiness score.
...
**Answer**: The top shelf finds a happy medium between healthiness score and amount of sugar.
...
**Answer**: As the number of reviews increases, the scores tend to increase.
...
**Answer**: The 80th percentile for the estimated price of a single cup of tea (in $) is $30.  This means that 80% of teas cost $30 or less for a single cup, while 20% of teas cost $30 or more for a single cup.
...
**Answer**: The most expensive 20% of reviews tend to have the fewest number of reviews.
...
**Answer**:  The variation of the white tea prices is smaller than that of the entire dataset.
...
**Answer**:  Masters teas seem to be the most significant outliers.  For a large price premium, customers can get the highest rated teas.
