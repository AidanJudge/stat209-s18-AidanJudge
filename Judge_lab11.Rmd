...
Answer:  There is a linear relationship between the observed mass of an adult male and the observed mass of its egg at birth.
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  scale_y_log10() +
  labs(color = "Parrots") +
  annotate("text", x = 100, y = 4, label = "Parrots", color = "red")
```
...
Answer:  Yes this showers a very linear relationship between the x and y variables.
...
ggplot(birds, aes(male_mass, egg_mass)) +
  ...
  annotate("text", x = 218.7, y = 115, label = "Red-tailed Tropicbird", color = "red")
```
...
```{r}
big_birds <- filter(birds, male_mass > 500)
ggplot(birds, aes(male_mass, egg_mass)) +
  geom_point(size=.15) +
  geom_point(color = "red", data = big_birds) +
  scale_x_log10() +
  scale_y_log10() +
  labs(color = "Big Birds") +
  annotate("text", x = 3000, y = 20, label = "Big Birds", color = "red") +
  ggtitle("Adult Bird Mass vs. Egg Mass") +
  xlab("Adult Male Bird Mass") +
  ylab("Bird Egg Mass") +
  labs(color = "Birds over 500 grams")
```
