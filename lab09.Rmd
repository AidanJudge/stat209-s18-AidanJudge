...
ggplot(murder, aes(murders_2014, murders_2015)) +
  geom_point(aes(color=murders_2015, size=change)) +
  geom_text(aes(label = city), size = 2) +
  xlab("Murders in 2014") +
  ylab("Murders in 2015") +
  ggtitle("Murders in Major U.S. Cities") +
  labs(size= "2014-15 Increase", color="Murders in 2015") +
  annotate("rect", xmin = 200, xmax = 450,
                   ymin = 250, ymax = 500,
                   fill = "purple", alpha = 0.1) + 
  annotate("text", x = 350, y = 400,
           label = "Most Murders")
